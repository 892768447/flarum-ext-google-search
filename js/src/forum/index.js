...
app.initializers.add('irony-google-search', app => {
    ...
    extend(DiscussionsSearchSource.prototype, 'view', function (view, query) {
        ...
        view.splice(2, 0, 
            <li className="Dropdown-header">{app.translator.trans('irony-google-search.forum.search.search_heading')}</li>,
            <li>
                {LinkButton.component({
                    icon: 'fas fa-search',
                    children: app.translator.trans('irony-google-search.forum.search.all_search_button', {query}),
